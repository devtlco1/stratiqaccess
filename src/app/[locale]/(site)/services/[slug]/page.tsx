    ...
    <>
      ...
      <section className="pt-32 pb-16 lg:pt-40 lg:pb-24 bg-white">
        <Container>
          ...
          <div className="mt-8">
            <div className="float-right rtl:float-left w-full sm:w-2/5 ms-0 sm:ms-8 mb-6 sm:mb-8 relative aspect-square sm:aspect-4/3 rounded-2xl overflow-hidden">
              <Image
            ...
            <h2 className="clear-both pt-2 mt-10 font-display text-xl text-navy">{t("includesHeading")}</h2>
            <ul className="mt-5 flex flex-col gap-4 max-w-3xl">
